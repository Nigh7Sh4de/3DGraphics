...
ParticleRenderable::ParticleRenderable(ShaderProgramPtr shaderProgram, ParticlePtr particle, glm::vec4 color) :
    ...
    m_pBuffer(0), m_cBuffer(0), m_nBuffer(0)
{
    ...
    for (int i = 0; i < thetaStep; ++i) {
        for(int j = 0; j < phiStep; ++j) {
            ...
            color = color != glm::vec4(-1.0) ? color : glm::vec4(1.0,0.0,0.0,1.0); 
            ...
            color = color != glm::vec4(-1.0) ? color : glm::vec4(0.0,0.0,1.0,1.0); 
            m_colors.push_back(color);
            m_colors.push_back(color);
            m_colors.push_back(color);
        }
