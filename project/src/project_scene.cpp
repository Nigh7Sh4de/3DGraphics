...
//GABRIEL
    ...
    glm::vec3 s_position(-15.0,-7.0,0.0), s_spotDirection = glm::normalize(glm::vec3(0.0,1.0,0.0)); // posicao da lampada e direcao dela
    ...
    //viewer.addRenderable(spotLightRenderable); // show the cone or not
